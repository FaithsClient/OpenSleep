...
public class WorldRenderUtils {
    ...
    public static void renderFour(EntityLivingBase base) {
        if (base != null) {
            int color = Client.getINSTANCE().getFileManager().friendsConfig.isFriend(base.getName()) ? -11157267 : Colors.getHealthColor(base.getHealth(), base.getMaxHealth());

            if (ModuleManager.getModuleByClass(KillAura.class).isEnabled() && KillAura.target != null
