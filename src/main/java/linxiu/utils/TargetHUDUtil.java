...
public class TargetHUDUtil {
    public static Minecraft mc = Minecraft.getMinecraft();

    public static void drawRoundedRect(float left, float top, float right, float bottom, int color) {
        //Left
        TargetHUDUtil.drawRect(left - 0.5f, top + 0.5f, left, bottom - 0.5f, color);
        //Right
        TargetHUDUtil.drawRect(right, top + 0.5f, right + 0.5f, bottom - 0.5f, color);
        //Top
        TargetHUDUtil.drawRect(left + 0.5f, top - 0.5f, right - 0.5f, top, color);
        //Bottom
        TargetHUDUtil.drawRect(left + 0.5f, bottom, right - 0.5f, bottom + 0.5f, color);
        TargetHUDUtil.drawRect(left, top, right, bottom, color);
    }

    public static void drawBorderedRect(float left, float top, float right, float bottom, float thickness, int color) {
        //Left
        TargetHUDUtil.drawRect(left - thickness, top, left, bottom, color);
        //Right
        TargetHUDUtil.drawRect(right, top, right + thickness, bottom, color);
        //Top
        TargetHUDUtil.drawRect(left, top + thickness, right, top, color);
        //Bottom
        TargetHUDUtil.drawRect(left, bottom, right, bottom + thickness, color);
    }
    ...
    public static void drawImage(ResourceLocation image, int x, int y, float width, float height, float alpha) {
        ...
        Gui.drawModalRectWithCustomSizedTexture(x, y, 0.0f, 0.0f, (int) width, (int) height,
                width, height);
    ...
    public static void drawRoundedRect(float x, float y, float right, float bottom, int borderC, int insideC) {
        ...
        TargetHUDUtil.drawRect(x + 1.0f, y + 1.0f, right - 1.0f, bottom - 1.0f, insideC);
    ...
    public static void drawOutlinedRect(float x, float y, float width, float height, float lineSize, int lineColor) {
        TargetHUDUtil.drawRect(x, y, width, y + lineSize, lineColor);
        TargetHUDUtil.drawRect(x, height - lineSize, width, height, lineColor);
        TargetHUDUtil.drawRect(x, y + lineSize, x + lineSize, height - lineSize, lineColor);
        TargetHUDUtil.drawRect(width - lineSize, y + lineSize, width, height - lineSize, lineColor);
    }
