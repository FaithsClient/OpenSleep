...
extends GuiScreen {
    ...
    public void drawScreen(int i, int j, float f) {
        ...
        FontLoaders.kiona18.drawCenteredString("Add Alt", this.width / 2, 20, -1);
        this.username.drawTextBox();
        this.password.drawTextBox();
        this.combined.drawTextBox();
        if (this.username.getText().isEmpty()) {
            FontLoaders.kiona18.drawStringWithShadow("Username / E-Mail", this.width / 2 - 96, 66.0f, -7829368);
        }
        if (this.password.getText().isEmpty()) {
            FontLoaders.kiona18.drawStringWithShadow("Password", this.width / 2 - 96, 106.0f, -7829368);
        }
        if (this.combined.getText().isEmpty()) {
            FontLoaders.kiona18.drawStringWithShadow("Email:Password", this.width / 2 - 96, 146.0f, -7829368);
        }
        FontLoaders.kiona18.drawCenteredString(this.status, this.width / 2, 30, -1);
    ...
    public void initGui() {
        ...
        this.combined = new GuiTextField(1, this.mc.fontRendererObj, this.width / 2 - 100, 140, 200, 20);
