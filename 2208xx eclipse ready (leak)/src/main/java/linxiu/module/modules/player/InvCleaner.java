...
public class InvCleaner extends Module {
    ...
    public final Option Food = new Option("Food", true);
    public final Option sort = new Option("Sort", true);
    public final Option Archery = new Option("Archery", true);
    public final Option Sword = new Option("Sword", true);
    public final Option InvCleaner = new Option("Cleaner", true);
    public final Option UHC = new Option("UHC", false);
    public final Option inventoryOnly = new Option("Inventory Only", true);

    public final Numbers<Number> Delay = new Numbers<Number>("Delay", 5.0, 2.0, 10.0, 1.0);
    public final Numbers<Number> BlockCap = new Numbers<Number>("Block Cap", 128.0, 0.0, 256.0, 8.0);
