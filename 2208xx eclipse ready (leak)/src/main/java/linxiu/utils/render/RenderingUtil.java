...
public class RenderingUtil {
	...
	public static double[] boundingBox(double x, double y, double z, AxisAlignedBB boundingBox) {
		...
		boolean shouldRender = pos1[2] > 0.0D && pos1[2] <= 1.0D && pos2[2] > 0.0D && pos2[2] <= 1.0D && pos3[2] > 0.0D
				&& pos3[2] <= 1.0D && pos4[2] > 0.0D && pos4[2] <= 1.0D && pos5[2] > 0.0D && pos5[2] <= 1.0D
				&& pos6[2] > 0.0D && pos6[2] <= 1.0D && pos7[2] > 0.0D && pos7[2] <= 1.0D && pos8[2] > 0.0D
				&& pos8[2] <= 1.0D;
		if (shouldRender) {
			return new double[] { -1337.0D, -1337.0D, -1337.0D, -1337.0D, -1337.0D, -1337.0D, -1337.0D, -1337.0D,
					-1337.0D, -1337.0D, -1337.0D, -1337.0D, -1337.0D, -1337.0D, -1337.0D, -1337.0D, -1337.0D, -1337.0D,
					-1337.0D, -1337.0D };
		} else {
			...
			return new double[] { pos1[0], pos1[1], pos2[0], pos2[1], pos3[0], pos3[1], pos4[0], pos4[1], pos5[0],
					pos5[1], pos6[0], pos6[1], pos7[0], pos7[1], pos8[0], pos8[1], startX, startY, endX, endY };
		}
	}
